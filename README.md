This is one solution for the coding game Skynet Revolution Episode 1 found at https://www.codingame.com/ide/puzzle/skynet-revolution-episode-1.

This solution is using Breadth First Search to look for the closest Gateway from the location of the agent and cut the link to that gateway from the last node that we visisted. 

Here is the description of the game copied from the site mentioned above:
